...
<?php $akn = array();?>
<?php $akn_total = array();?>
                  <?php foreach($total_pembelian_akun as $akun) : ?>

                    <?php $akn[] = $akun->an; ?>
                    <?php $akn_total[] = $akun->total; ?>
                  <?php endforeach; ?>

<?php $tgl = array();?>
<?php $tgl_total = array();?>
                  <?php foreach($total_pembelian_tanggal as $tanggal) : ?>

                    <?php $tgl[] = $tanggal->tanggal; ?>
                    <?php $tgl_total[] = $tanggal->total; ?>
                  <?php endforeach; ?>
...
<script src="<?php echo base_url('assets/dist')?>/js/ready.min.js"></script>
  ...
  <script>
    ...
    var myBarChart = new Chart(barChart, {
      ...
      data: {
        labels: [
           <?php foreach($total_pembelian_akun as $usr) : ?>
            "<?php echo $usr->an ?>",
          <?php endforeach; ?>
          ],
        datasets : [{
