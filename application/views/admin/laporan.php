			...
			<div class="content">
				<div class="page-inner">
					<div class="page-header">
						<h4 class="page-title">Data Laporan Pemesanan</h4>
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
                                    ...
                                    <a href="#modalAdd" data-toggle="modal" title="" class="btn btn-danger btn-md" data-original-title="Edit Task">
                                                        Input Tanggal Cetak
                                                    </a>
								</div>
								<div class="card-body">
                  ...
                  <tr>
                    ...
                    <td>
                    	<div class="form-button-action">
															...
															<a href="<?php echo base_url('Pengguna/Hapus_Pesanan/'.$dtl->id)?>" type="button" data-toggle="tooltip" title="" class="btn btn-link btn-danger" data-original-title="Remove" onclick="javascript: return  confirm('Anda  yakin  hapus?')">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
               <form action="<?php echo base_url('Admin/Cetak_Laporan'); ?>" method="post">
      
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group form-group-default">
                                <label>Atas Nama</label>
                                <input id="tglA" type="datetime-local" class="form-control" placeholder="tanggal awal" name="tglA" >                               
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group form-group-default">
                                <label for="tglB">tglB</label>
                    <input type="datetime-local" class="form-control" id="tglB" placeholder="tanggal akhir" name="tglB">
            ...
            <div class="modal-body">
               <form action="<?php echo base_url('Pengguna/Update_Pesanan'); ?>" method="post">
                   ...
                   <label for="tanggal">tanggal</label>
                    ...
                    <select class="form-control" id="kualitas" name="kualitas" readonly>
                    ...
                    <input type="text" class="form-control" id="volume" name="volume" value="<?php echo $d->volume; ?>" placeholder="<?php echo $d->volume; ?>" readonly>
                            </div>
                        </div>
                    ...
                    <input type="text" class="form-control" id="harga" name="harga" value="<?php echo $d->harga; ?>" placeholder="<?php echo $d->harga; ?>" readonly>
                            </div>
                        </div>
                    </div>
            </div>
